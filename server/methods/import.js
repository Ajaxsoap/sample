			...
			CSV().from.stream(
				...
				.on('record',Meteor.bindEnvironment(function(row,index){
					Enrollments.insert({
						...
						policyDetails: [
							{effectivityDate: new Date(row[8])},
							{maturityDate: new Date(row[9])}
